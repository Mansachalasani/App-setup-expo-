  ...
  return (
    <SafeAreaView style={styles.container}>
      <PatientHeader
        ...
        showBack
        onBack={() => router.back()}
        rightIconName={!editing && activeTab === 'profile' ? 'edit' : undefined as any}
        onRightPress={!editing && activeTab === 'profile' ? () => setEditing(true) : undefined}
      />
        ...
        >
          ...
          {!selectedEntity ? (
            <>
              ...
              <CleanTextInput
                label="Search doctors or organizations..."
                onChangeText={(query) => {
                ...
                placeholder="Apple Hospital, Dr. Smith..."
                left={
                  <MaterialIcons
                    name="search"
                    size={20}
