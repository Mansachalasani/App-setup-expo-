  ...
  const renderVisitCard = (visit: Visit) => (
    <View key={visit.id} style={styles.timelineRow}>
      <View style={styles.timelineCol}>
        <View style={[styles.timelineDot, { borderColor: getVisitAccent(visit)[0] }]} />
        ...
        <View style={styles.visitCard}>
          ...
          <View style={styles.visitTypeWrap}>
            <View style={styles.visitTypePill}>
              <MaterialIcons
                name={visit.visit_type?.includes('virtual') ? 'videocam' : (!visit.doctor_id || visit.visit_type === 'self_recorded') ? 'self-improvement' : 'medical-services'}
                size={14}
                color="#FFFFFF"
              />
